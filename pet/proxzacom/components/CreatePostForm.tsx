  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-2">
        ...
        <CldUploadButton uploadPreset={process.env.CLOUDINARY_UPLOAD_PRESET} className={`h-48 border-2 mt-4 border-dotted grid place-items-center bg-slate-100 rounded-md relative ${imageUrl && "pointer-events-none"}`} onUpload={handleImageUpload}>
          <div>
